...
$(eval $(call add_include_file,libs/libvtrutil/vtr_array_view.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_assert.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_bimap.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_cache.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_color_map.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_digest.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_dynamic_bitset.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_error.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_expr_eval.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_flat_map.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_geometry.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_hash.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_linear_map.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_list.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_log.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_logic.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_map_util.h))
$(eval $(call add_include_file,libs/libvtrutil/vtr_math.h))
...
$(eval $(call add_include_file,libs/libarchfpga/arch_check.h))
$(eval $(call add_include_file,libs/libarchfpga/arch_error.h))
$(eval $(call add_include_file,libs/libarchfpga/arch_types.h))
$(eval $(call add_include_file,libs/libarchfpga/arch_util.h))
$(eval $(call add_include_file,libs/libarchfpga/cad_types.h))
$(eval $(call add_include_file,libs/libarchfpga/clock_types.h))
$(eval $(call add_include_file,libs/libarchfpga/echo_arch.h))
$(eval $(call add_include_file,libs/libarchfpga/logic_types.h))
$(eval $(call add_include_file,libs/libarchfpga/parse_switchblocks.h))
$(eval $(call add_include_file,libs/libarchfpga/physical_types_util.h))
$(eval $(call add_include_file,libs/libarchfpga/physical_types.h))
# $(eval $(call add_include_file,libs/libarchfpga/read_fpga_interchange_arch.h))
...
vcxsrc: $(GENFILES) $(EXTRA_TARGETS)
	...
	set -e; for f in `ls $(filter %.cc %.cpp,$(GENFILES)) $(addsuffix .cc,$(basename $(OBJS))) $(addsuffix .cpp,$(basename $(OBJS))) 2> /dev/null`; do \
		echo "Analyse: $$f" >&2; cpp -std=c++14 -MM -I. -D_YOSYS_ $$f; done | sed 's,.*:,,; s,//*,/,g; s,/[^/]*/\.\./,/,g; y, \\,\n\n,;' | grep '^[^/]' | sort -u | grep -v kernel/version_ > srcfiles.txt
